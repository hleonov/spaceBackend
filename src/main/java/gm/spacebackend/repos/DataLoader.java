...
public class DataLoader implements CommandLineRunner {
    ...
    private void LoadUsers() {
    	chrRepo.save(new CharacterConsumables("William", new Consumable(12), new Consumable(17), new Consumable(18), 
    	...
    	chrRepo.save(new CharacterConsumables("Yergon", new Consumable(12), new Consumable(17), new Consumable(18), 
